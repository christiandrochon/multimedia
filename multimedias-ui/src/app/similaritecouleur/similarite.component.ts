...
@Component({
  selector: 'app-similarite',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './similarite.component.html',
  styleUrl: './similarite.component.css'
})
export class SimilariteComponent implements OnInit {
  ...
  constructor(private similariteService: SimilariteService) {
  }
  ...
  // Lance la recherche par similarité
  searchSimilarImages() {
    this.loading = true;
